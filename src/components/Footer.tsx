    ...
    <footer className="bg-dark-bg text-gray-400">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm">
            &copy; {new Date().getFullYear()} HW Marketplace. All rights reserved.
          </p>
          <div className="flex items-center gap-6">
            <span className="text-sm hover:text-white cursor-pointer">Twitter</span>
            <span className="text-sm hover:text-white cursor-pointer">Instagram</span>
            <span className="text-sm hover:text-white cursor-pointer">YouTube</span>
          </div>
        </div>
      </div>
    </footer>

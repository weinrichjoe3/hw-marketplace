  ...
  return (
    <div className="p-4 md:p-10">
      ...
      <div className="max-w-2xl space-y-6 md:space-y-8">
        {/* Profile */}
        <div className="rounded-xl border border-card-border p-4 md:p-6">
        ...
        <div className="rounded-xl border border-card-border p-4 md:p-6">
          ...
          <div className="space-y-3">
            {["New messages", "Price drops on watched items", "Weekly digest"].map((label) => (
              <label key={label} className="flex items-center justify-between min-h-[44px]">
        ...
        {/* Danger Zone */}
        <div className="rounded-xl border border-red-200 p-4 md:p-6">
          <h2 className="font-semibold text-red-600 mb-2">Danger Zone</h2>
          <p className="text-sm text-gray-500 mb-4">
            Once you delete your account, there is no going back.
          </p>
          <button className="rounded-lg border border-red-300 px-4 py-2.5 text-sm font-medium text-red-600 hover:bg-red-50 transition-colors min-h-[44px]">
            Delete Account
          </button>
        </div>
      </div>
